...
ad_ip_instance axi_ad9361_cmos_tx axi_cmos_tx
#ad_connect sys_cpu_clk axi_cmos_tx/s_axi_aclk
#ad_connect sys_cpu_resetn axi_cmos_tx/s_axi_aresetn
ad_cpu_interconnect 0x7C460000 axi_cmos_tx
...
#gpio  power ctrl 
ad_ip_instance  axi_gpio axi_gpio_power
ad_ip_parameter axi_gpio_power CONFIG.C_GPIO_WIDTH 2 
ad_ip_parameter axi_gpio_power CONFIG.C_ALL_OUTPUTS 1
create_bd_port -dir O -from 1 -to 0 powerctrl
# ad9361 core(s)
...
#ad_connect  axi_cmos_tx/fifo_rd_data_1  tx_fir_interpolator/data_in_1
...
ad_connect axi_ad9361/l_clk      axi_cmos_tx/clk  
ad_connect  axi_cmos_tx/adc_data_i0  axi_ad9361/dac_data_i0
ad_connect  axi_cmos_tx/adc_data_q0  axi_ad9361/dac_data_q0
ad_connect axi_cmos_tx/adc_data_i  axi_ad9361/adc_data_i0
ad_connect axi_cmos_tx/adc_data_q  axi_ad9361/adc_data_q0
#ad_connect axi_cmos_tx/adc_data_i rx_fir_decimator/data_out_0
#ad_connect axi_cmos_tx/adc_data_q rx_fir_decimator/data_out_1
ad_connect axi_cmos_tx/adc_valid_i rx_fir_decimator/valid_out_0
ad_connect axi_cmos_tx/adc_valid_q rx_fir_decimator/valid_out_1 
ad_ip_instance ila ila_0
ad_ip_parameter ila_0 CONFIG.C_MONITOR_TYPE {Native}
ad_ip_parameter ila_0 CONFIG.C_ENABLE_ILA_AXI_MON {false}
ad_ip_parameter ila_0 CONFIG.C_NUM_OF_PROBES 14
ad_ip_parameter ila_0 CONFIG.C_PROBE0_WIDTH 16
ad_ip_parameter ila_0 CONFIG.C_PROBE1_WIDTH 16
ad_ip_parameter ila_0 CONFIG.C_PROBE2_WIDTH 16
ad_ip_parameter ila_0 CONFIG.C_PROBE3_WIDTH 16

ad_ip_parameter ila_0 CONFIG.C_DATA_DEPTH   4096
ad_connect ila_0/probe0 axi_cmos_tx/adc_data_i0
ad_connect ila_0/probe1 axi_cmos_tx/adc_data_q0
ad_connect ila_0/probe2 axi_cmos_tx/adc_data_i
ad_connect ila_0/probe3 axi_cmos_tx/adc_data_q
ad_connect ila_0/probe4 axi_ad9361/dac_valid_i0
ad_connect ila_0/probe5 axi_ad9361/dac_valid_q0
ad_connect ila_0/probe6 axi_ad9361/adc_valid_i0
ad_connect ila_0/probe7 axi_ad9361/adc_valid_q0
ad_connect ila_0/probe8 axi_ad9361/dac_r1_mode
ad_connect ila_0/probe9 axi_ad9361/adc_r1_mode
ad_connect ila_0/probe10 axi_ad9361/dac_enable_i0
ad_connect ila_0/probe11 axi_ad9361/dac_enable_q0
ad_connect ila_0/probe12 axi_ad9361/adc_enable_i0
ad_connect ila_0/probe13 axi_ad9361/adc_enable_q0
ad_connect ila_0/clk    axi_cmos_tx/clk   
# interconnects
ad_cpu_interconnect 0x41200000 axi_gpio_power
...
ad_connect powerctrl axi_gpio_power/gpio_io_o
# interrupts
